...
public class RecipeSwingApp extends JFrame {
    ...
    private String currentSortOption = "无排序";
    ...
    private void initNavbar() {
        ...
        JComboBox<String> sortCombo = new JComboBox<>(new String[]{"无排序", "rating_desc", "date_desc", "calories_asc"});
    ...
    private void showLoginDialog() {
        ...
        loginBtn.addActionListener(e -> {
            // 模拟登录（任意ID/密码都登录成功）
            String authorId = idInput.getText().trim();
            if (!authorId.isEmpty()) {
                isLogin = true;
                ...
                JOptionPane.showMessageDialog(loginDialog, "请输入用户ID！");
            }
        });
    ...
    private void showRecipeDetail(RecipeRecord recipe) {
        ...
        if (!isLogin) {
            ...
            postCommentPanel.add(postBtn, BorderLayout.EAST);
    ...
    // 渲染评论
    private void renderComments(JPanel commentsList, List<String[]> comments, int[] visibleComments) {
    ...
    private void updateUserUI() {
        ...
        // TODO: 模拟数据 待修改
        recipeCountLabel.setText(String.valueOf(0L));
        followerCountLabel.setText(String.valueOf(1L));
        // 显示我的食谱
